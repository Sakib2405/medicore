  ...
  try {
    ...
    if (!kIsWeb) {
      try {
        ...
        // App Check may fail on some devices (e.g. emulators without Play Services).
        // The app should still work — Firebase operations will rely on user auth
        // and Firestore security rules instead.
        print('Warning: Firebase App Check activation failed (non-fatal): $e');
      }
    }
